...
from help_fcts import kern, make_spline, ssmm_loogcv, ssmm_S, loogcv_S
...
lbda_krr_n, sigma_krr_n=ssmm_loogcv(x_tr,x_te,lbdas_cv,sigmas_cv)
...
lbda_krr_y, sigma_krr_y=ssmm_loogcv(x_tr,x_te,lbdas_cv,sigmas_cv,y_tr)
...
lbda_sp_n,_=ssmm_loogcv(x_tr,x_te,lbdas_cv)
fh_sp_n=B_te@np.linalg.solve(B_tr.T@B_tr+lbda_sp_n*Omega+1e-8*np.eye(B_tr.shape[1]),B_tr.T@y_tr)
lbda_sp_y,_=ssmm_loogcv(x_tr,x_te,lbdas_cv,y_tr=y_tr)
